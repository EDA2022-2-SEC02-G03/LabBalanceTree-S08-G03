...
def printMenu():
    ...
    # lab 9, agregar opcion 5 en el menu, consultar por REPORTING_AREA
    print("5- Consultar por rango de area reportada ")
    print("0- Salir")
    print("*******************************************")
...
while True:
    ...
    if int(inputs[0]) == 1:
        ...
        numareas = controller.getCrimesByRangeArea(cont, InitialArea,
                                                      FinalArea)
        print("\nTotal de crimenes en el rango de areas: " +
              str(numareas))
